...
public interface PipelineMapper {
    ...
    PipelineResource toAzurePipelineResource(ConfigurationsResource configuration, TemplateResource template, String callbackRef);

    @Named("refNameFromBranch")
    static String refNameFromBranch(String branch) {
        return String.format("refs/heads/%s", branch);
    }
    @AfterMapping
    static void addCallbackRef(String callbackRef, @MappingTarget PipelineResource target) {
