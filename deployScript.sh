...
nohup java -jar /home/$USER/odm-platform-adapter-executor-azuredevops-server-1.0.0.jar > /home/$USER/odm-platform-adapter-executor-azuredevops-server-1.0.0.jar.log 2>&1 &
